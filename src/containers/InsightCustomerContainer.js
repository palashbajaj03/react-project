...
import CustomerGraph from '../components/InsightDashboard/CustomerGraph';
import CustomerTopExpert from '../components/InsightDashboard/CustomerTopExpert';
import CustomerContactability from '../components/InsightDashboard/CustomerContactability'
import SentimentLevelCard from '../components/InsightDashboard/SentimentLevelCard'
import CustomerFollowUpGraph from '../components/InsightDashboard/CustomerFollowUpGraph';
import Tone from '../components/InsightDashboard/Tone';

class InsightCustomerContainer extends Component {
   constructor(props) {
      super(props);
      this.state = {
                  ...
                  <div className="col-lg-8 col-md-8 col-sm-12">
                     <div className="row">
                        <div className="col-lg-12 col-md-12 col-md-12">
                           <div className="conversation-graph calc-graph">
                              <CustomerGraph dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />
                           </div>
                        </div>
                     </div>
                     <div className="row">
                        <div className="col-lg-12 col-md-12 col-md-12">
                           <Tone dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />
                        </div>
                     </div>
                  </div>
                  <div className="col-lg-4 col-md-4 col-sm-12">
                     <SentimentLevelCard dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />
                     <CustomerTopExpert date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugins} />
                     <CustomerContactability date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />
                  </div>
               </div>
               <div className="row">
                  <div className="col-lg-12 col-md-12 col-md-12">
                     <div className="combine">
                        <CustomerFollowUpGraph dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />
                     </div>
                  </div>
               </div>
            </div>
...
export default connect(mapStateToProps, mapActionToProps)(InsightCustomerContainer);