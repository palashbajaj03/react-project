      ...
      <React.Fragment>
        <div className="page-title-row" >
          <div className="page-title-box">
            <h2 className="page-title"> Conversation Dashboard </h2>
        ...
        <div className="key-matrices-graph mt45" id="conversation-dash">
          <div className="row">
            <div className="col-lg-8 col-md-8 col-sm-12">
              <ConversationDashboardGraph dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />
            </div>
            <div className="col-lg-4 col-md-8 col-sm-12">
              <ConversationCompetitionMentionCard
                date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin}
              />
            </div>
          </div>
          <div className="row">
            <div className="col-lg-8 col-md-8 col-sm-12">
              ...
              <ConversationDurationGraph dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />

              <TopicTrends dashboard={this.props.dashboard} date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} topics={this.props.readTopics} />

              <ConversationPeakTimeGraph date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugin} />

            </div>
            <div className="col-lg-4 col-md-4 col-sm-12">


              <ConversationPredefinedTopics date_filter={{ from: this.state.date_from, to: this.state.date_to }} plugin={this.state.list_plugins.length > 0 ? this.state.list_plugins : this.state.list_plugins} topics={this.props.readTopics} />
